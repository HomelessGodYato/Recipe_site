...
from .controllers import RecipeIngredientController, recipe_ingredient_controller, recipe_image_controller, \
    recipe_stage_controller, recipe_stage_recipe_ingredient_controller, recipe_controller
...
RECIPE_FORM_STATE_STAGE = "RECIPE_FORM_STATE_FIRST"
RECIPE_FORM_STATE_LAST = "RECIPE_FORM_STATE_FIRST"
...
def recipe_form_view(request, id=0):
    ...
    if recipe_form_state == RECIPE_FORM_STATE_FIRST:
        return recipe_form_first_view(request, id=id)
        pass
